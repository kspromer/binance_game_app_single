          ...
          Column(
            ...
            children: [
              Text.rich(
                ...
                style: theme.textTheme.headline3.copyWith(color: textLetColor,fontSize: 12.sp,fontWeight: FontWeight.w800,height: 1,),
              ),
              BgDropUpText.point3("${price}",textLetColor)
            ],
          ),
          Text(" ${this.lotteryResults ?? '牛六'}",style: theme.accentTextTheme.headline3.copyWith(color: textLetColor,fontSize: 10.sp,fontWeight: FontWeight.w400),)
        ],
      ),
    );
